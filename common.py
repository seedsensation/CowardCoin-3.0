...
class coin:
    ...
    def __init__(self):
        ...
        coinrarities = [
            ...
            ["gold", "<a:goldcoin:813889535699189871>", "gold", 95, [20, 50]],
            ["SUPER RARE red", "<a:redcoin:844545670709772290>", "ultrarare", 99, [75, 100]],
            ["ULTIMATE White", "<a:white:1136340312529318018>", "white", 100, [500, 1000]]
        ]
...
class CoinButton(discord.ui.View):
    ...
    async def getcoin(self, interaction: discord.Interaction, button: discord.ui.button):
        if client.coinactive:
            ...
            s2 = "s" if current.value != 1 else ""
            await interaction.response.send_message(
                f"""
    {current.emote} Congratulations, {interaction.user.display_name}! You gained {current.value} CowardCoin{s2}!
